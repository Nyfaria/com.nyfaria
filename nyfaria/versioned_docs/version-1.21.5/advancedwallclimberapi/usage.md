...
```
See [SpiderMixin](http://github.com/Nyfaria/NyfsSpiders/blob/1.21.5-AWCAPI/Common/src/main/java/com/nyfaria/nyfsspiders/mixin/SpiderMixin.java) for more details.